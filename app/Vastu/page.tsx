import MoverAndPackersForm from "@/app/components/contact/VastuForm";
      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-[#CE6D44] text-white rounded-2xl shadow-lg p-8">
            <h2 className="text-3xl font-semibold mb-6">We’ll provide you best Vastu Wizards</h2>
            <MoverAndPackersForm />
          </div>
        </div>
      </div>
